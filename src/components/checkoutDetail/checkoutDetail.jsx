                ...
                <div className="personalInfo">
                    <form action="#">
                        <div className="input">
                            ...
                            <input value={formFields.name} type="text" className="form-control" name="name" onChange={handleChange}/>
                        </div>
                        <div className="input">
                            <label htmlFor="">Email: </label><br />
                            <input value={formFields.email} type="email" className="form-control" name="email" onChange={handleChange}/>
                        </div>
                        <div className="input">
                            <label htmlFor="">Telefono: </label><br />
                            <input value={formFields.phone} type="text" className="form-control" name="phone" onChange={handleChange}/>
                        </div>
                        <button 
                            type="button" 
                            onClick={onSubmit}
